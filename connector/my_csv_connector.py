...
print(CsvModel.__annotations__)
...
# self.data = [
#     CsvModel(name='table1', column_names=['c1', 'c2'], column_types=['INT', 'DATE']),
#     CsvModel(name='table2', column_names=['c1', 'c2', 'c3'], column_types=['STRING', 'STRING', 'STRING'])
# ]